...
class ContinuumRobotSim:
    def __init__(self, urdf_path="continuum_robot.urdf",connection_mode=p.DIRECT):
    ...
    def judgement(self,theta_1,alpha_1,alpha_2,theta_2,alpha_3,theta_3,base_theta,length):
        theta_1=max(min(theta_1,3.14),-3.14)
        theta_2=max(min(theta_2,3.14),-3.14)
        theta_3=max(min(theta_3,3.14),-3.14)
        alpha_1=max(min(alpha_1,3.14),-3.14)
        alpha_2=max(min(alpha_2,3.14),-3.14)
        alpha_3=max(min(alpha_3,3.14),-3.14)
        base_theta=max(min(base_theta,3.14),-3.14)
        length=max(min(length,2),-2)
        self.set_robot(theta_1,alpha_1,theta_2,alpha_2,theta_3,alpha_3,base_theta,length)
    def stepwise_action(self,theta_1,alpha_1,theta_2,alpha_2,theta_3,alpha_3,base_theta,length):
        self.judgement(self.theta_1+theta_1,self.alpha_1+alpha_1,
                                 self.alpha_2+alpha_2,self.theta_2+theta_2,
                                 self.alpha_3+alpha_3,self.alpha_3+theta_3,
                                 self.base_theta+base_theta,self.length+length)
